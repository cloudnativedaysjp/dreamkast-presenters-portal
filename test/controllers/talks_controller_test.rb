...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { abstract: @talk.abstract, conference_id: @talk.conference_id, title: @talk.title } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { abstract: @talk.abstract, conference_id: @talk.conference_id, title: @talk.title } }
