...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference('Conference.count') do
      post conferences_url, params: { conference: { abbr: @conference.abbr, name: @conference.name, status: @conference.status } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { abbr: @conference.abbr, name: @conference.name, status: @conference.status } }
